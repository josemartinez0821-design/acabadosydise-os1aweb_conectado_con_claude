...
const mensaje = ref(null) // { texto, icono, tipo }
let temporizador = null

export function useCenterMessage() {
  function mostrarMensajeCentral(texto, { icono = 'ri-emotion-happy-line', tipo = 'bienvenida', duracion = 2600 } = {}) {
    if (temporizador) clearTimeout(temporizador)
    mensaje.value = { texto, icono, tipo }
