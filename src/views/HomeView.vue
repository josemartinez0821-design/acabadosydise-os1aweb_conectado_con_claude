...
function promoLink(promo) {
  if (promo.id_producto) return `/productos/${promo.id_producto}`
...
<template>
  ...
  <section class="section" style="background:white;">
    <div class="container">
      ...
      <Swiper class="promo-swiper" :modules="[Pagination, Autoplay]" loop :speed="700" :autoplay="{ delay: 5000, disableOnInteraction: false }" :slides-per-view="1" :space-between="24" :pagination="{ clickable: true }">
        <SwiperSlide v-for="promo in catalog.promociones" :key="promo.id">
  ...
  <section class="section" style="background:var(--off-white);">
    <div class="container">
      ...
      >
        <SwiperSlide v-for="s in catalog.servicios" :key="s.id_servicio">
