...
// El selector de color solo aplica a Pinturas y Vinilos (id_categoria 1) — para el resto de
// categorías el atributo "Color" es solo informativo, no un catálogo de tonos para elegir.
const esProductoPintura = computed(() => producto.value?.id_categoria === 1)
...
// (ver catalog.js: CATEGORIAS_FABRICACION_PROPIA) — no en Drywall/PVC ni Herramientas, que son
