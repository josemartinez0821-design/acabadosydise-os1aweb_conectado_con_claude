...
const form = ref({
  ...
  ciudad: auth.usuario ? `${auth.usuario.ciudad}, ${auth.usuario.departamento}` : '',
  mensaje: '',
})
          ...
          <div class="contacto-card">
            ...
            <form @submit.prevent="enviarMensaje">
              ...
              <div class="form-group">
                ...
                <input v-model="form.ciudad" type="text" class="form-control" placeholder="Ej: Pitalito, Huila" autocomplete="address-level2" />
              </div>
              <div class="form-group">
