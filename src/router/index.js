...
const routes = [
  ...
  { path: '/admin/dashboard', name: 'admin-dashboard', component: () => import('../views/admin/DashboardView.vue'), meta: { requiresAuth: true, requiresAdmin: true } }, // RF12
  { path: '/admin/productos', name: 'admin-productos', component: () => import('../views/admin/AdminProductosView.vue'), meta: { requiresAuth: true, requiresAdmin: true } }, // RF16/RF17
  { path: '/admin/ventas', name: 'admin-ventas', component: () => import('../views/admin/AdminVentasView.vue'), meta: { requiresAuth: true, requiresAdmin: true } },
  { path: '/admin/cotizaciones', name: 'admin-cotizaciones', component: () => import('../views/admin/AdminCotizacionesView.vue'), meta: { requiresAuth: true, requiresAdmin: true } },
  { path: '/admin/reportes', name: 'admin-reportes', component: () => import('../views/admin/AdminReportesView.vue'), meta: { requiresAuth: true, requiresAdmin: true } }, // RF19
