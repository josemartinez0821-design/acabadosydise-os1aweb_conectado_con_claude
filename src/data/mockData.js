...
export const MockData = {
  ...
  cotizaciones: [
    ...
    { id_cotizacion: 4, numero_cotizacion: 'COT-004', id_usuario: 3, fecha: '2026-05-05', estado: 'en_revision', total_estimado: 220000, observaciones: 'Cotización para pintura de fachada exterior', validez_dias: 15 },
    { id_cotizacion: 5, numero_cotizacion: 'COT-005', id_usuario: 3, fecha: '2026-05-10', estado: 'rechazada', total_estimado: 60000, observaciones: 'Cliente decidió posponer el proyecto', validez_dias: 15, respuesta: 'No contamos con disponibilidad para esta fecha. Con gusto podemos evaluar otras fechas — escríbenos por WhatsApp para reprogramar.' },
    { id_cotizacion: 6, numero_cotizacion: 'COT-006', id_usuario: 3, fecha: '2026-05-18', estado: 'aprobada', total_estimado: 132000, observaciones: 'Instalación de drywall en habitación adicional', validez_dias: 15, respuesta: 'Confirmamos la instalación de drywall según lo solicitado. El total incluye materiales y mano de obra.' }
  ],
